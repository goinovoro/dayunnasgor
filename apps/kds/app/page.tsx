      ...
      <aside className={`${isSidebarOpen ? 'w-72 border-r-[4px]' : 'w-0 border-r-0'} bg-white border-black flex flex-col shrink-0 z-20 overflow-hidden transition-all duration-300 ease-in-out`}>
        <div className="w-72 h-full flex flex-col">
          ...
          <div className="p-4 flex-1 overflow-y-auto space-y-4 bg-gray-100">
            ...
            <button 
              className="w-full text-left p-4 font-black transition-transform border-[3px] border-black rounded-none shadow-[4px_4px_0_0_rgba(0,0,0,1)] active:translate-y-1 active:translate-x-1 active:shadow-none bg-white text-black hover:bg-yellow-400"
            >
